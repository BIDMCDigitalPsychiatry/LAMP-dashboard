...
class LAMP {
    ...
    public static function start() {
        ...
        Flight::map('error', function($e) {
            try {
                ...
                else return Flight::json(["error" => LAMP::log($e)], 500);
            } catch(Throwable $t) {
	...
	/**
	 * The internal log() function returns a UUID matching the created log entry.
	 * If you pass a PDOException, it will automatically log the message and SQL.
	 */
	public static function log($log) {
		...
		error_log("[$uuid] $log");
		//if (file_exists($file))
		//     file_put_contents($file, '[' . date("Y-m-d h:i:sa") . '] ' . $str . '\n', FILE_APPEND);

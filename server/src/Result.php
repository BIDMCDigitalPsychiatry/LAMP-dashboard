...
class Result extends LAMP {
     ...
     * @OA\Property(
     *   ref="#/components/schemas/Timestamp",
     *   description="The date and time when this event ended recording.",
     * )
     */
     ...
     *   description="The summary information for the result as determined by the activity that created this result event.",
     * )
     */
     ...
     *   },
     *   summary="Get a single result, by identifier.",
     *   description="Get a single result, by identifier.",
     *   @OA\Parameter(
     *     name="result_id",
     *     in="path",
     *     required=true,
     ...
     *     "$ref"="#/components/schemas/Result"}
     *   },
     *   summary="Get the set of all results produced by a given participant interacting with a given activity, by identifiers of both.",
     *   description="Get the set of all results produced by a given participant interacting with a given activity, by identifiers of both.",
     *   @OA\Parameter(
     *     name="participant_id",
     *     in="path",
     *     required=true,
     ...
     *     "$ref"="#/components/schemas/Result"}
     *   },
     *   summary="Get the set of all results produced by a given participant, by identifier.",
     *   description="Get the set of all results produced by a given participant, by identifier.",
     *   @OA\Parameter(
     *     name="participant_id",
     *     in="path",
     *     required=true,
     ...
     *     "$ref"="#/components/schemas/Result"}
     *   },
     *   summary="Get the set of all results produced by all participants enrolled in a given study interacting with a given activity, by identifiers of both.",
     *   description="Get the set of all results produced by all participants enrolled in a given study interacting with a given activity, by identifiers of both.",
     *   @OA\Parameter(
     *     name="study_id",
     *     in="path",
     *     required=true,
     ...
     *     "$ref"="#/components/schemas/Result"}
     *   },
     *   summary="Get the set of all results produced by all participants enrolled in any study conducted by a given researcher interacting with a given activity, by identifiers of both.",
     *   description="Get the set of all results produced by all participants enrolled in any study conducted by a given researcher interacting with a given activity, by identifiers of both.",
     *   @OA\Parameter(
     *     name="researcher_id",
     *     in="path",
     *     required=true,
     ...
     *     "$ref"="#/components/schemas/Result"}
     *   },
     *   summary="Get the set of all results produced by interacting with a given activity, by identifier.",
     *   description="Get the set of all results produced by interacting with a given activity, by identifier.",
     *   @OA\Parameter(
     *     name="activity_id",
     *     in="path",
     *     required=true,
     ...
     *     "$ref"="#/components/schemas/Result"}
     *   },
     *   summary="Get the set of all results produced by all participants enrolled in a given study, by identifier.",
     *   description="Get the set of all results produced by all participants enrolled in a given study, by identifier.",
     *   @OA\Parameter(
     *     name="study_id",
     *     in="path",
     *     required=true,
     ...
     *     "$ref"="#/components/schemas/Result"}
     *   },
     *   summary="Get the set of all results produced by all participants enrolled in any study conducted by a given researcher, by identifier.",
     *   description="Get the set of all results produced by all participants enrolled in any study conducted by a given researcher, by identifier.",
     *   @OA\Parameter(
     *     name="researcher_id",
     *     in="path",
     *     required=true,
     ...
     *     "$ref"="#/components/schemas/Result"}
     *   },
     *   summary="Get the set of all results.",
     *   description="Get the set of all results.",
     *   @OA\Parameter(ref="#/components/parameters/Export"),
     *   @OA\Parameter(ref="#/components/parameters/XPath"),
     *   @OA\Response(response=200, ref="#/components/responses/Success"),
     *   @OA\Response(response=403, ref="#/components/responses/Forbidden"),

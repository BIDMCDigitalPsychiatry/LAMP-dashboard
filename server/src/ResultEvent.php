...
require_once __DIR__ . '/driver/v0.1/ResultEventDriver.php';
...
class ResultEvent extends LAMP {
    ...
    public static function all_by_participant($participant_id) {
    	...
    	return ResultEvent::_get(null, $participant_id);
    }
    ...
    public static function all_by_researcher($researcher_id) {
        ...
        return ResultEvent::_get(null, null, $_id->part(1));
    }

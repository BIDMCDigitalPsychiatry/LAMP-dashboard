...
import { 
  Card, Tooltip, Typography, Grid, Fab, Divider, 
  ...
  return (
    <Draggable draggableId={`${index}`} index={index} {...props}>
      {provided => (
        ...
        >
        <Tooltip enterDelay={1000} title="Drag the handle on the left to change the order in which this Activity appears in the group.">
